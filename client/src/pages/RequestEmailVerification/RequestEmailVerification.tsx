...
const RequestEmailVerification = () => {
    ...
    const onClickRequestResetPassword = () => {
        ...
        api.requestEmailVerification({identifier})
            .then(response => {
                setMessage('Check your email inbox and verify your email')
                setIdentifier('');
    ...
    return (
        <div>
            <div className="sidebar-header text-center py-4 myModal">
                <h3><Link to="/login">Secure password manager</Link></h3>
            </div>
            <Row className="justify-content-center mt-3">
                <Col xl="8" sm="10">
                    <Card>
                        <CardBody>
                            <CardTitle><h5>Request email verification</h5></CardTitle>
